#!/bin/bash
#SBATCH --job-name=sweep_dllm_0.9_mmlu             # Job name
#SBATCH --output="./slurm_logs/sweep_dllm_0.9_mmlu_%A.out"       # Standard output log
#SBATCH --error="./slurm_logs/sweep_dllm_0.9_mmlu_%A.err"         # Standard error log
